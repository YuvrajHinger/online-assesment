            ...
            <div class="mother-grid-inner">
                ...
                <div class="validation-system">
                    <div id="step1" class="validation-form">
                        ...
                        <?php  } ?>
                        <center>
                            <h3>Guideline to Upload Excel File</h3>
                            <hr>
                            <img class="img-responsive mx-auto d-block"
                                style="border-radius: 10px; border: solid blue; padding: 2%"
                            ...
                            <hr>
                            <button onclick="changeView('step1','step2')" style="border-radius: 20px;"
                    ...
                    <div id="step2" class="validation-form" style="display:none">
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12 form-group">
                                <button type="submit" style="border-radius: 20px; border-color: black;"
                                    class="btn btn-primary" name="excel_submit">Submit</button>
                                <button type="reset" style="border-radius: 20px; border-color: black;"
                                    class="btn btn-default" value="reset">Reset</button>
                                <button onclick="changeView('step2','step1')"
                                    style="border-radius: 20px; border-color: black;"
                                    class="btn btn-primary float-right">View Guide-line</button>
                            </div>
                            <div class="clearfix"> </div>
                        </form>
                    </div>
