                            ...
                            <div class="row">
                                <div class="col-md-7" style="margin-bottom: 10px">
                                    ...
                                    <table class="table table-bordered table-hover myform">
                                        ...
                                        <tbody>                 
                                            <?php $query="select * from `candidate_login` where status = '0'"; $getData=$con->query($query); $i=0; 
                                            while($fetchData=$getData->fetch_assoc()){ $i++; $id=$fetchData['candidate_id']; $username=$fetchData['candidate_username']; $password=$fetchData['candidate_password']; ?>
                                            <tr>
                                                <td> <?php echo $i;?></td>
                                ...
                                <div class="col-md-5" style="margin-bottom: 10px">                                    
                                    ...
                                    <form action="" method="post" class="myform">
                                        <div class="col-md-12 form-group1 group-mail">
                                            ...
                                            <input type="text" name="candidate_username" class="form-control" placeholder="username" style=" border-radius: 20px; color: black;" autofocus required>                                     
                                        </div>
                                        <div class="clearfix"> </div>                                                                
                                        <div class="col-md-12 form-group1 group-mail">
                                            <label class="control-label"> Candidate Password</label>
                                            <input type="password" name="candidate_password" class="form-control" placeholder="password" style=" border-radius: 20px; color: black;" required>                                                                         
                                        </div>
                                        <div class="clearfix"> </div>                                                                
