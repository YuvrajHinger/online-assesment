                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                            ...
                            <center>
                                ...
                                <img class="img-responsive mx-auto d-block"
                                    ...
                                    src="../include/image/candidate_upload.png" alt="Guideline For Upload" />
                                <hr>
                                <img class="img-responsive mx-auto d-block"
                                    style="border-radius: 10px; border: solid blue; padding: 2%"
                                    src="../include/image/save_type.png" alt="Guideline For Upload" />
                                <hr>
                                <h4 class="caption text-dark">File Format: filename.xls</h4>
                                <hr>
                                <a href="/online-assesment/Database/candidate_add_format.xls" download>Download
                                    Format.</a>
