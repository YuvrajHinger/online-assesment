...
if (!isset($_SESSION['detail_exam_id'])) header("Location: report.php");
$exam_id = $_SESSION['detail_exam_id'];
$candidate_id = $_SESSION['detail_applicant_id'];
        ...
        <div class="left-content">
            <div class="mother-grid-inner">
                ...
                <div class="bg-light breadcrumb">
                    <div id="first">
                        <h4>Candidate Name: <?php echo $applicant_id; ?></h4>
                        <h4>Exam Title: <?php echo $fetchData['title']; ?></h4>
                        <h4>Score: <?php echo $_SESSION['score']; ?></h4>
                    </div>
                    <hr>
...
<?php unset($_SESSION['detail_exam_id']); ?>
