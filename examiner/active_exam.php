        ...
        <div class="page-container">
 		                ...
 		                <div class="validation-form">                                                
                                    ...
                                    <table class="table table-bordered table-hover myform">
                                        ...
                                        <tbody>              
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $name;?></td> 
                                                <td>			                                    			                                    
                                                    <a style="margin: 0px 0px 10px 0px;" class="btn btn-primary" onclick="alert('working soon')">Edit</a>
                                                    <a style="margin: 0px 0px 10px 0px;" class="btn btn-danger" rel="tooltip" title="Delete"  data-toggle="modal" href="#delete<?php echo $id ;?>">Delete</a>                                                                                        
                                ...
                                <div class="col-md-5">
                                    ...
                                    <form action="" method="post" class="myform">                                
                                        <div class="col-md-6" style="margin: 0px 0px 20px 0px;">
                                            ...
                                            <input type="text" name="exam_title" placeholder="Title" class="form-control" style=" border-radius: 20px; color: black;" autofocus required>                                     
                                        </div>                                
                                        <div class="col-md-6" style="margin: 0px 0px 20px 0px;">                                
                                            <label class="control-label"> Date of Exam</label>
                                            <input type="text" name="exam_date" class="form-control datepicker" style=" border-radius: 20px; color: black;" required>                                     
                                        </div>
                                        <div class="col-md-6" style="margin: 0px 0px 20px 0px;">                                                                
                                            <label class="control-label"> Time of Exam</label>
                                            <input type="time" name="exam_time" placeholder="Exam time" class="form-control" style=" border-radius: 20px; color: black;" required>
                                        </div>                                                                
                                        <div class="col-md-6" style="margin: 0px 0px 20px 0px;">                                
                                            <label class="control-label"> Duration</label>
                                            <input type="time" name="exam_duration" placeholder="Exam Duration" class="form-control" style=" border-radius: 20px; color: black;" required>
                                        </div>                                                                
                                        <div class="col-md-6" style="margin: 0px 0px 20px 0px;">                                
                                            <label class="control-label"> Purpose</label>
                                            <input type="text" name="exam_purpose" placeholder="Purpose" class="form-control" style=" border-radius: 20px; color: black;" required>
                                        </div>
                                        <div class="col-md-6" style="margin: 0px 0px 20px 0px;">                                
                                            <label class="control-label"> Nos Of Question</label>
                                            <input type="number" name="exam_question" placeholder="nos of questions" class="form-control" style=" border-radius: 20px; color: black;" required>                               
                                        </div>                                
                                        <div class="col-md-6" style="margin: 0px 0px 20px 0px;">                                
                                            <label class="control-label"> Total Marks</label>
                                            <input type="number" name="exam_marks" placeholder="Total marks" class="form-control" style=" border-radius: 20px; color: black;" required>                               
                                        </div>
                                        <div class="col-md-6" style="margin: 0px 0px 20px 0px;">                                
                                            <label class="control-label"> Security Key</label>                                        
                                            <input type="text" name="exam_key" placeholder="Authentication Key" class="form-control" style=" border-radius: 20px; color: black;" required>
                                        </div>                                
                                        <div class="col-md-6" style="margin: 0px 0px 20px 0px;">                                
                                        ...
                                        <div class="col-md-12 form-group">
                                            <button type="submit" style="border-radius: 20px;" class="btn btn-primary" name="step1">Submit</button>
                            ...
                            <?php } 
                                ...
                                <form id="finalSubmit" class="row" method="post">
                                    <input id="totalRows" name="step2" type="hidden" value="<?php echo $_SESSION['save_data_step1']->exam_question; ?>"/>
                                    <div class="col-md-5">
                                        <h4 class="float-left">Total Question: <?php echo $_SESSION['save_data_step1']->exam_question; ?></h4>
                                        <h4 class="float-right">Selected Question: <a id="putRows">0</a></h4>
                                        <div class="clearfix"></div>
                                        <div class="form-group float-right">
                                            <button type="button" onclick="submitStep2()" style="border-radius: 20px;" class="btn btn-primary" >Submit</button>
                                            <button type="submit" style="border-radius: 20px;" class="btn btn-default" name="reset">Cancel</button>                                            
                                        </div>
                                        <div class="clearfix"></div>
                                    ...
                                    <div class="col-md-7">                                        
                                        ...
                                        <select onchange="generateTable(this.value)" style="border-radius: 20px;" class="form-control select2" name="title">                                    
                                        ...
                                        <div class="myform">                                        
                                            <div class="row">
                                                <div class="col-md-4">
                                                    ...
                                                    <input type="text" readonly value="<?php echo $_SESSION['save_data_step1']->exam_title ?>" class="form-control"/>
                                                </div>
                                                <div class="col-md-4">
                                                    <label>exam date</label>   
                                                    <input type="text" readonly value="<?php echo $_SESSION['save_data_step1']->exam_date ?>" class="form-control"/>
                                                </div>
                                                <div class="col-md-4">
                                                    <label>exam time</label>   
                                                    <input type="text" readonly value="<?php echo $_SESSION['save_data_step1']->exam_time ?>" class="form-control"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label>exam duration</label>   
                                                    <input type="text" readonly value="<?php echo $_SESSION['save_data_step1']->exam_duration ?>" class="form-control"/>
                                                </div>
                                                <div class="col-md-4">
                                                    <label>exam purpose</label>    
                                                    <input type="text" readonly value="<?php echo $_SESSION['save_data_step1']->exam_purpose ?>" class="form-control"/>
                                                </div>
                                                <div class="col-md-4">
                                                    <label>exam question</label>   
                                                    <input type="text" readonly value="<?php echo $_SESSION['save_data_step1']->exam_question ?>" class="form-control"/>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <label>exam marks</label>  
                                                    <input type="text" readonly value="<?php echo $_SESSION['save_data_step1']->exam_marks ?>" class="form-control"/>
                                                </div>
                                                <div class="col-md-4">
                                                    <label>exam key</label>    
                                                    <input type="text" readonly value="<?php echo $_SESSION['save_data_step1']->exam_key ?>" class="form-control"/>
                                                </div>
                                                <div class="col-md-4">
                                                    <label>negative marking</label>    
                                                    <input type="text" readonly value="<?php echo $_SESSION['save_data_step1']->negative_marking ?>" class="form-control"/>                                        
                                                </div>
                                            </div><hr>                                            
                                            <button type="submit" style="border-radius: 20px;" class="btn btn-primary" name="confirm_save">Confirm Save</button>
                                            <button type="submit" style="border-radius: 20px;" class="btn btn-default" name="reset">Cancel</button>                                            
                                        </div>                                        
                                    </div>                                    
                                </form>
            ...
            function selectQuestion(condition,value,index){                                
                if(condition){                    
                    ...
                    cell2.innerHTML = '<input type="hidden" name="quiz_id[]" value="'+value+'"/><a class="btn btn-default" style="border-radius: 20px;" onclick="delete_option(\'putTable\',this)">Delete</a>';
